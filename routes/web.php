...
route::get('biodata-saya',[MyController::class,'biodataa']);
...
route::get('sibarang/{id}',[MyController::class,'sibarang']);
route::get('sipembelian/{id}',[MyController::class,'sipembelian']);
route::get('sipesanan/{id}',[MyController::class,'sipesanan']);
route::get('sipembeli/{id}',[MyController::class,'sipembeli']);
route::get('sisuplier/{id}',[MyController::class,'sisuplier']);